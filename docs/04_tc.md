...
Traffic_control works seperate from pihole. So if I ping a domain that is bllocked on pihole and throttled by fw-censor, 
some pings go through loss rate is between 15% and 80%